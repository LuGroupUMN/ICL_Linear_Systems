...
npy_name = 'Elliptic_Result_OOD_test_a.npy'
...
# plt.figure(1)
# plt.loglog(m_ls, l2_mat[0, ...], label=rf'$(\alpha_1,\beta_1)=$(' + str(para_ls[0][0])+','+str(para_ls[0][1])+')')
# for i in range(1, len(para_ls)//2+1):
#     plt.loglog(m_ls, l2_mat[i, ...], '--', label=rf'$(\alpha_1,\beta_1)=$(' + str(para_ls[i][0])+','+str(para_ls[i][1])+')')
#
...
# plt.savefig(f'test_a_L2_1_alp1_{alpha_1}_beta1_{beta_1}_alp2_{alpha_2}_beta2_{beta_2}_alp3_{alpha_3}_beta3_{beta_3}.png', bbox_inches = 'tight')
#
# plt.figure(2)
# plt.loglog(m_ls, l2_mat[0, ...], label=rf'$(\alpha_1,\beta_1)=$(' + str(para_ls[0][0])+','+str(para_ls[0][1])+')')
...
# plt.yticks(fontsize=12)
# plt.legend(fontsize=12)
# plt.savefig(f'test_a_L2_2_alp1_{alpha_1}_beta1_{beta_1}_alp2_{alpha_2}_beta2_{beta_2}_alp3_{alpha_3}_beta3_{beta_3}.png', bbox_inches = 'tight')
#
#
#
# plt.figure(3)
# plt.loglog(m_ls, h1_mat[0, ...], label=rf'$(\alpha_1,\beta_1)=$(' + str(para_ls[0][0])+','+str(para_ls[0][1])+')')
# for i in range(1, len(para_ls)//2+1):
#     plt.loglog(m_ls, h1_mat[i, ...], '--', label=rf'$(\alpha_1,\beta_1)=$(' + str(para_ls[i][0])+','+str(para_ls[i][1])+')')
#
# #plt.title(f'd={d},n={n},N={20000}', fontsize=18)
# plt.xlabel(r'$m$', fontsize=18)
...
# plt.yticks(fontsize=12)
# plt.legend(fontsize=12)
# plt.savefig(f'test_a_H1_1_alp1_{alpha_1}_beta1_{beta_1}_alp2_{alpha_2}_beta2_{beta_2}_alp3_{alpha_3}_beta3_{beta_3}.png', bbox_inches = 'tight')
#
# plt.figure(4)
# plt.loglog(m_ls, h1_mat[0, ...], label=rf'$(\alpha_1,\beta_1)=$(' + str(para_ls[0][0])+','+str(para_ls[0][1])+')')
# for i in range(len(para_ls)//2+1, len(para_ls)):
...
# plt.yticks(fontsize=12)
# plt.legend(fontsize=12)
# plt.savefig(f'test_a_H1_2_alp1_{alpha_1}_beta1_{beta_1}_alp2_{alpha_2}_beta2_{beta_2}_alp3_{alpha_3}_beta3_{beta_3}.png', bbox_inches = 'tight')
#
#
# plt.show()